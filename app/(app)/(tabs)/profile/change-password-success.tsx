        ...
        <>
            ...
            <ScrollView style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Text style={[styles.header, { marginTop: insets.top + 10 }]}>Update Password Link Sent</Text>
                    ...
                    <Pressable style={styles.continueButton} onPress={() => {
                        // TO DO: where should users go after being sent their reset password email
                        // 1. back to sign in page
                        // 2. back to profile index/home page
                        router.replace('/');
                    }}>
