import { StyleSheet, ScrollView, Platform, View, Button, Pressable, Text, TextInput, Keyboard, Dimensions } from 'react-native';
        ...
        <>
            ...
            <ScrollView style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Text style={[styles.header, { marginTop: insets.top + 10 }]}>Registration</Text>
                    <Text style={styles.subTitle}> Success !</Text>
                    <View style={{ marginTop: 50, marginBottom: 10, alignSelf: 'center'}}>
                        <SuccessCheckSVG />
                    </View>
                    <Text style={styles.subText}>We sent a verification link to your email please check your inbox or spam folder for it</Text>
